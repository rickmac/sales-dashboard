...
def main():
    ...
    st.plotly_chart(revenue_by_country(selected_region), width='stretch')
    
    # Chart 2
    st.subheader('2. Profit Trend Over Time')
    st.plotly_chart(profit_trend_over_time(selected_region), width='stretch')
    
    # Chart 3
    st.subheader('3. Product Performance')
    st.plotly_chart(product_performance(selected_region), width='stretch')
    
    # Chart 4
    st.subheader('4. Sales Channel Comparison')
    st.plotly_chart(channel_comparison(selected_region), width='stretch')
